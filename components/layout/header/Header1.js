...
import OtpRegistration from "@/components/elements/OtpRegistration";
            ...
            <div className="auto-container">
              <div className="top-inner">
                <ul className="info-list clearfix">
                  <li>
                    <i className="icon-2"></i>Phone:{" "}
                    <Link href="tel:+919738105105">+91 7510411202</Link>
                  </li>
                  <li>
                    <i className="icon-2"></i>Email:{" "}
                    <a href="mailto:info@ayurshoppee.com">
                ...
                <div className="outer-box py-2">
                  ...
                  <>
                    ...
                    <div
                      ...
                      className="d-flex btn-box"
                    >
                      {orders?.length > 0 && (
                        <Link
                          href="/orders"
                          className="card-link d-flex align-items-center text-white fw-semibold"
                      ...
                      {!isCheckoutRoute && (
                        <Link
                          href="/checkout"
                          className="theme-btn btn-two mobile-hide"
                        >
                          <span>Order now</span>
                        </Link>
                      )}
...
>
  <div>
    <OtpRegistration closeModal={closeModal} />
    <div className="text-center my-3 fw-bold" style={{letterSpacing: 2}}>OR</div>
    <GoogleRegister closeModal={closeModal} />
  </div>
</Modal>
